...
\hang{Python}{
    ...
    Well versed in the standard scientific libraries (NumPy, SciPy, Matplotlib) and Pandas to a lesser extent. \\
    Personal projects including a \href{https://github.com/fuverdred/Crossword-Filler}{tool for creating themed crosswords}, web-scraping scripts and a \href{https://github.com/fuverdred/pH-Monitor}{device for monitoring and controlling the pH of soil}.
}
