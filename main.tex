...
\newcommand{\EducationEntry}[4]{
		...
		\colorbox{Black}{%
			\parbox{6.5em}{%
			\hfill\color{White}\textbf{#2}}} \par  % Duration
		\noindent \textit{#3} \par   % School
		\hangindent=2em\hangafter=0 \small #4 % Description
		\hangindent=2em \normalsize \par}}
...
{   
    ...
    The fundamentals of what makes a good ice nucleator remain poorly understood at the nanoscale. In my PhD I developed three experimental methods: a novel way of automating a standard experimental technique (\href{https://amt.copernicus.org/articles/13/2785/2020/}{published}), an updated version of an automated lag time apparatus (\href{https://aip.scitation.org/doi/10.1063/1.1145586}{ALTA}) for ice nucleation studies and an environmental chamber for freezing acoustically levitated water droplets. Some relevant highlights of my PhD work include:
    \begin{itemize}
...
\SchoolEntry{Alleyn's School}{2005-2012}
{
...
\hang{Python}{
    Four years of experience, well versed in the standard scientific libraries (NumPy, SciPy, Matplotlib) and Pandas to a lesser extent. Personal projects including a \href{https://github.com/fuverdred/Crossword-Filler}{tool for creating themed crosswords}, web-scraping scripts and a \href{https://github.com/fuverdred/pH-Monitor}{device for monitoring and controlling the pH of soil}.
}
